  ...
  elseif(VAR MATCHES "PYTHON2")
    if(CMAKE_HOST_WIN32)
      ...
      if(DEFINED ENV{PROCESSOR_ARCHITEW6432})
          set(_HOST_ARCHITECTURE $ENV{PROCESSOR_ARCHITEW6432})
      else()
          set(_HOST_ARCHITECTURE $ENV{PROCESSOR_ARCHITECTURE})
      endif()

      if(_HOST_ARCHITECTURE STREQUAL "x86")
          set(ARCHIVE "python2-x86.msi")
          set(SUBDIR "python2-x86")
          ...
          set(ARCHIVE "python2-x64.msi")
          set(SUBDIR "python2-x64")
